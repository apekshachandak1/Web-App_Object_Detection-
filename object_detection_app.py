...
st.markdown("""
    <h3 style="color:#1E30AAFF; text-align:center; font-family: 'Arial', sans-serif;">Welcome to the Object Detection App! 🤖🔬</h3>
    <p style="text-align:center; font-size:18px; color:#555;">Upload an image to detect objects! 🌟</p>
    <p style="text-align:center; font-size:16px; color:#777;">Choose an image and watch the magic unfold! 🎥💡</p>
